...
class A13_Enum_zMethods {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(day4.getClass());    // class Java_Classes.EN_WeekDays
        System.out.println(EN_WeekDays.class);  // >>> class Java_Classes.EN_WeekDays
        ...
        // 	getDeclaringClass()
        System.out.println(day1.getDeclaringClass()); // >>> class Java_Classes.EN_WeekDays
        System.out.println(day1.getClass());          // >>>  class Java_Classes.EN_WeekDays
