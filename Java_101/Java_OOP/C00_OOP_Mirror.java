...
public class C00_OOP_Mirror {
    ...
    public static void main(String[] args) {
        ...
        C00_OOP_Not_Public_C C = new C00_OOP_Not_Public_C();  // 只有同包类的类可以
        ...
        // Test 同包子类环境
        C00_OOP_Sub Sub_In = new C00_OOP_Sub();
        Sub_In.pub_test();
        Sub_In.def_test();
        // Sub_In.pri_test();
        Sub_In.prot_test();
...
class C00_OOP_Sub extends C00_OOP_Public_A {   // 继承Public_A
