 ...
 * First: javac java_reference.C06_Java_Main.java to generate Class file
 * Then:  java java_reference.C06_Java_Main 10 7    // 10 and 7 will be the two parameter for main function
