...
public class LC045_Jump_Game_II {
    ...
    public static void main(String[] args) {
        int[] q1 = {2, 1};
        assert new LC045_Jump_Game_II().jump(q1) == 1 : "Edge 1";

        int[] q2 = {2, 3, 1, 1, 4};
        assert new LC045_Jump_Game_II().jump(q2) == 2 : "Example 1";

        int[] q3 = {2, 9, 6, 5, 7, 0, 7, 2, 7, 9, 3, 2, 2, 5, 7, 8, 1, 6, 6, 6, 3, 5, 2, 2, 6, 3};
        assert new LC045_Jump_Game_II().jump(q3) == 5 : "Long 1";

        int[] q4 = {5, 6, 5, 3, 9, 8, 3, 1, 2, 8, 2, 4, 8, 3, 9, 1, 0, 9, 4, 6, 5, 9, 8, 7, 4, 2, 1, 0, 2};
        assert new LC045_Jump_Game_II().jump(q4) == 5 : "Long 2";

        int[] q5 = {5, 6, 4, 4, 6, 9, 4, 4, 7, 4, 4, 8, 2, 6, 8, 1, 5, 9, 6, 5, 2, 7, 9, 7, 9, 6, 9, 4, 1,
                6, 8, 8, 4, 4, 2, 0, 3, 8, 5};
        assert new LC045_Jump_Game_II().jump(q5) == 5 : "Long 3";
